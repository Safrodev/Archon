...
public class EffectRegistry {
    ...
    public static final StatusEffect RAGE = register("rage", new CustomStatusEffect(StatusEffectCategory.BENEFICIAL, 0xE81E1E).addAttributeModifier(EntityAttributes.GENERIC_ATTACK_SPEED, "AF8B6E3F-3328-4C0A-AA36-5BA2BB9DBEF3", 3.0D, EntityAttributeModifier.Operation.MULTIPLY_TOTAL));
